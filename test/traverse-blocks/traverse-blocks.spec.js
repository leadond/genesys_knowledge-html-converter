...
describe('traverse-blocks', function () {
    it('should walk through all the leafs', () => {
        ...
        expect(blocks.filter((block) => block.type === 'Text')).length(4, 'text blocks in the document');
        expect(blocks.filter((block) => block.type === 'Image')).length(3, 'image blocks in the document');
    });
...
//# sourceMappingURL=traverse-blocks.spec.js.map