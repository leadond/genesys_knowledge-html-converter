...
describe('convert-html-to-blocks', function () {
    ...
    describe('image', function () {
        ...
        it('image-with-properties-max-alt-length', async function (options = {}) {
    ...
    */
    describe('options', function () {
        ...
        it('handleWidthWithUnits-pixel-no-input-unit', testHandleWidthWithUnitEnabled);
        ...
        it('handleWidthWithUnits-percentage-image-from-width-attribute', testHandleWidthWithUnitEnabled);
        it('handleWidthWithUnits-pixel-image', testHandleWidthWithUnitEnabled);
        it('handleWidthWithUnits-pixel-image-from-width-attribute', testHandleWidthWithUnitEnabled);
        it('handleWidthWithUnits-pixel-image-no-input-unit', testHandleWidthWithUnitEnabled);
    ...
    async function test(options = {}) {
        ...
        try {
            ...
            addActualAndExpectedJsonsToErrorMessage(error, actualJson, expectedJson);
            throw error;
        }
    }
    async function testHandleWidthWithUnitEnabled() {
        return test.call(this, {
            handleWidthWithUnits: true,
        });
    }
    async function testHandleWidthWithUnitDisabled() {
        return test.call(this, {
            handleWidthWithUnits: false,
        });
    }
    async function testBaseFontSize() {
        return test.call(this, { baseFontSize: 32 });
    }
    async function testUndefinedOptions() {
        return test.call(this, {
            baseFontSize: undefined,
            handleWidthWithUnits: undefined,
        });
    }
    async function testHyperlinkWithRelativePath() {
        return test.call(this, {
            hyperlinkBaseUrl: 'https://www.example.com/',
        });
    }
    function addActualAndExpectedJsonsToErrorMessage(error, actualJson, expectedJson) {
        error.message =
            `\n- - - - - - - - - - - - - - - - - - - - -\n` +
                `actual json:\n` +
                `- - - - - - - - - - - - - - - - - - - - -\n` +
...
//# sourceMappingURL=convert-html-to-blocks.spec.js.map